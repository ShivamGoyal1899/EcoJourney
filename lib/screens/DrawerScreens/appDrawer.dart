...
class _MyDrawerState extends State<MyDrawer> {
  ...
  void setdDrawerListArray() {
    drawerList = [
      ...
      DrawerList(
        index: DrawerIndex.SixthSense,
        labelName: 'Sixth Sense',
        icon: new Icon(Icons.security),
      ),
      DrawerList(
        index: DrawerIndex.TravelHistory,
        labelName: 'Travel History',
        icon: new Icon(Icons.history),
      ),
      DrawerList(
        index: DrawerIndex.Rewardz,
        labelName: 'Redeem GreenPoints',
        icon: new Icon(Icons.card_giftcard),
      ),
      DrawerList(
        index: DrawerIndex.Rickshaw,
        labelName: 'Rickshaw Registration',
          ...
          Column(
            children: <Widget>[
              ...
              ListTile(
                ...
                subtitle: Text('Microsoft | IncubateIND Innovation Series',
                    style: new TextStyle(
