...
var blackBlueGradient = new LinearGradient(
  colors: [Colors.blueGrey.shade800, Colors.black38],
  tileMode: TileMode.clamp,
  begin: Alignment.topLeft,
  end: Alignment.bottomRight,
  stops: [0.0, 1.0],
...
var thodaZyadaSexyGradient = new LinearGradient(
...
var xdGradient = new LinearGradient(
  colors: [const Color(0xFF52A7EA), const Color(0xFF712E98)],
  tileMode: TileMode.clamp,
  begin: Alignment.bottomLeft,
  end: Alignment.topRight,
...
var greyGradient = new LinearGradient(
  colors: [const Color(0xFFA9A9A9), const Color(0xFFF8F8F8)],
  tileMode: TileMode.clamp,
  begin: Alignment.bottomLeft,
  end: Alignment.topRight,
  stops: [0.0, 1.0],
...
var lightGredient = new LinearGradient(
  colors: [const Color(0xFFA9A9A9), const Color(0xFFF8F8F8)],
  tileMode: TileMode.clamp,
  begin: Alignment.bottomLeft,
  end: Alignment.topRight,
...
var blackBlueSexyGradient = new LinearGradient(
